...
client.on('inviteCreate', (invite) => {
    const channelLog = invite.guild.channels.cache.get(process.env.INVITE_LOGS_CHANNEL)
    const convite = {
        url: invite.url,
...
client.on('inviteDelete', (invite) => {
    console.log(invite)
    const channelLog = invite.guild.channels.cache.get(process.env.REVOKED_INVITE_LOGS_CHANNEL)
    const convite = {
        url: invite.url,
        canal: invite.channel,
